...
const RegionsMap = ({ cleanedDailyRegions }) => {
	...
	useEffect(() => {
		...
		document.querySelectorAll("[data-regioncode]").forEach((item) => {
			item.setAttribute(
				"fill",
				calculateRegionFill(item.dataset.regioncode)
			)
		})
	}, [])

	const regionsHighestValue = cleanedDailyRegions[0].nuovi_positivi

	const calculateRegionFill = (regionID) => {
		let regionTotal = 0

		if (regionID.indexOf(",") !== -1) {
			regionID.split(",").map((item, index) => {
				return (regionTotal += regionsData[item]?.nuovi_positivi)
			}, 0)
		} else regionTotal = regionsData[regionID]?.nuovi_positivi

		const opacity =
			regionTotal / regionsHighestValue > 0.1
				? regionTotal / regionsHighestValue
				: 0.1

		return "rgba(71,65,166," + opacity + ")"
	}
				...
				>
					<g id="sar">
						<polygon
							data-regioncode={20}
							className="st0"
							points="193,463 203.6,472.3 210,472.3 207.2,482 217.6,491.5 221.5,524.9 213.6,537.5 218.8,559.4
					...
					<g id="sic">
						<polygon
							data-regioncode={19}
							className="st0"
							points="374.4,704.6 363.7,710.2 365.6,729.2 370.8,741.8 400.2,750.4 430.8,770.3 449.7,778.2 467.9,785.6
					...
					<g id="cal">
						<polygon
							data-regioncode={18}
							className="st0"
							points="535.3,568.9 549.7,566.8 557.5,568.4 580.4,558.3 588.3,561.9 582.8,580.1 587.8,593.9 596.8,591.7
					...
					<g id="bas">
						<polyline
							data-regioncode={17}
							className="st0"
							points="601.7,531.5 594.6,517.6 583.9,510.9 573.6,513.4 562.7,498.3 554.7,497 551.1,487.2 545.2,482.3
					...
					<g id="pug">
						<polygon
							data-regioncode={10}
							className="st0"
							points="495.8,462 495.1,451.6 501.6,439.3 506.3,426.9 506.3,426.5 512,428.1 558.6,429.1 565.1,437.9
					...
					<g id="cam">
						<polyline
							data-regioncode={15}
							className="st0"
							points="430.8,479 451.6,508.7 460.5,507.9 470.9,524.1 489.6,523.2 498.6,538.3 493.9,549.6 509,555.6
					...
					<g id="mol">
						<polygon
							data-regioncode={14}
							className="st0"
							points="506.3,426.5 494.8,423.4 486.6,416.6 486.3,416.9 486.3,417.6 479.4,429.4 470.9,433.6 466.1,425.9
					...
					<g id="abr">
						<polygon
							data-regioncode={13}
							className="st0"
							points="408.8,362.9 411.8,367.3 410.3,379.3 404,379.6 412.7,410.2 399.9,412.2 398.7,420.7 415.9,433.3
					...
					<g id="laz">
						<polyline
							data-regioncode={12}
							className="st0"
							points="340.7,361.5 364.9,386.7 372.5,388.6 383.1,380.8 391.9,373 408.4,362.7 411.8,367.3 410.3,379.3
					...
					<g id="umb">
						<polygon
							data-regioncode={10}
							className="st0"
							points="408.1,362.9 391.9,373 383.1,380.8 372.5,388.6 364.9,386.7 340.7,361.5 340,337 352.6,331.2
					...
					<g id="mar">
						<polyline
							data-regioncode={11}
							className="st0"
							points="359.4,301.6 362.7,312.3 384,315.9 393.9,359.9 405.6,362.9 420.1,362.9 439.2,357.2 440.4,356.4
					...
					<g id="tos">
						<polygon
							data-regioncode={9}
							className="st0"
							points="244.4,361.5 254,357.8 260.4,352.8 262.3,363.2 	"
						/>
						<polygon
							data-regioncode={9}
							className="st0"
							points="247.7,273.2 247.1,262.9 236.5,252.4 235.2,242 249.1,240.7 261.4,254 272.3,255.2 277.3,264.5
					...
					<g id="emi">
						<polygon
							data-regioncode={8}
							className="st0"
							points="382.3,277.9 380.9,286.6 370.3,282 358.8,283.4 352.2,291.6 343.7,291 336.6,284.1 332.3,268.6
					...
					<g id="fri">
						<polyline
							data-regioncode={6}
							className="st0"
							points="398.8,159.1 398.7,158.8 396.5,149.9 390.5,144.7 376.8,146.3 369.5,134.5 372.2,123.1 364.3,110.1
					...
					<g id="ven">
						<polygon
							data-regioncode={5}
							className="st0"
							points="398.8,159.1 376.3,171.2 374.4,161.9 363.7,173.1 359.9,186.5 372.5,203.7 364.6,216.8 343.8,213.3
					...
					<g id="tre">
						<polygon
							data-regioncode={[21, 22]}
							className="st0"
							points="365.6,70.2 358.2,51 340,57.7 313.2,56.6 299.7,72.1 289.3,64.4 280,65.1 275.7,81.4 282.5,106.3
					...
					<g id="lom">
						<polygon
							data-regioncode={3}
							className="st0"
							points="276.1,81.7 282.5,106.3 279.5,116.1 275.4,126 279.4,138.4 288.5,138.9 293.2,143.8 289,148.2
					...
					<g id="lig">
						<polyline
							data-regioncode={7}
							className="st0"
							points="124.7,253.6 145.1,254.9 148.5,243.9 156.1,229.5 169.2,233.8 176,228.6 187.6,230.5 194.4,223.1
					...
					<g id="pie">
						<polygon
							data-regioncode={1}
							className="st0"
							points="110.6,153.1 129.3,155.6 139.6,149.9 145.7,151.2 151.1,146.6 147,128.8 147,122.5 177.7,85.5
					...
					<g id="vao">
						<polygon
							data-regioncode={2}
							className="st0"
							points="110.6,153.1 129.3,155.6 139.6,149.9 145.7,151.2 151.1,146.6 147,128.8 147,122.5 130.7,117
