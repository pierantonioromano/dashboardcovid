					...
					<div className="grid grid-cols-12 gap-1 rounded-3xl bg-black">
						<div className="col-span-12 p-8">
							...
							<p className="text-md text-white">
								I contenuti presenti su questo sito sono
								elaborati a partire dai dataset forniti dal
								Ministero della Salute, dalla Protezione Civile
								Italiana o da altre organizzazioni
								internazionali. Le informazioni qui contenute
								non costituiscono un documento ufficiale
								sull'andamento della pandemia e non
								sostituiscono i provvedimenti legislativi
								ufficiali.
							</p>
						</div>
						...
						<div className="col-span-12 md:col-span-6 pt-0 pb-6 md:py-6 px-8 text-left md:text-right">
							<p className="text-sm text-gray-500">
								powered by{" "}
								<a
									className="text-gray-400 hover:text-white"
